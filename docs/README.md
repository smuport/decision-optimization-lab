...
- [AI/Codex 项目指令](../AGENTS.md)

## 设计文档

- [系统架构设计](design/ARCHITECTURE.md)
- [数据库设计](design/DATABASE_DESIGN.md)
- [后端 API 设计](design/BACKEND_API_DESIGN.md)
- [前端设计](design/FRONTEND_DESIGN.md)
- [自动评测设计](design/AUTO_EVALUATION_DESIGN.md)
- [项目结构设计](design/PROJECT_STRUCTURE.md)
...
- [Git 工作流与提交规范](guides/GIT_WORKFLOW.md)
- [实施防偏离约束](guides/IMPLEMENTATION_GUARDRAILS.md)

## 架构决策记录

- [ADR-0001 MVP 架构](decisions/ADR-0001-mvp-architecture.md)
